...
defmodule DocuSign.Model.Decline do
  ...
  @type t :: %__MODULE__{
          ...
          :buttonTextMetadata => PropertyMetadata.t() | nil,
          ...
          :declineReasonMetadata => PropertyMetadata.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:buttonTextMetadata, :struct, PropertyMetadata)
    ...
    |> Deserializer.deserialize(:declineReasonMetadata, :struct, PropertyMetadata)
