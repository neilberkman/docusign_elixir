...
defimpl Poison.Decoder, for: DocuSign.Model.FormulaTab do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:isPaymentAmountMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
    ...
    |> deserialize(:roundDecimalPlacesMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
