...
defmodule DocuSign.Model.AccountUiSettings do
  ...
  @type t :: %__MODULE__{
    ...
    :enableEasySignCanUseMultiTemplateApplyMetadata => DocuSign.Model.SettingsMetadata.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.AccountUiSettings do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:enableEasySignCanUseMultiTemplateApplyMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:enableEasySignTemplateUploadMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:enableEnvelopeCopyWithDataMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:enableLegacySendflowLinkMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:hasExternalLinkedAccountsMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:hideSendAnEnvelopeMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:hideUseATemplateInPrepareMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:hideUseATemplateMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:orderBasedRecipientIdGenerationMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:removeEnvelopeForwardingMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:shouldRedactAccessCodeMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:uploadNewImageToSignOrInitialMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
  end
end
