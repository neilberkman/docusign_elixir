...
defmodule DocuSign.Model.Zip do
  ...
  @type t :: %__MODULE__{
    ...
    :useDash4 => String.t | nil,
    :useDash4Metadata => DocuSign.Model.PropertyMetadata.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.Zip do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:concealValueOnDocumentMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
    ...
    |> deserialize(:useDash4Metadata, :struct, DocuSign.Model.PropertyMetadata, options)
