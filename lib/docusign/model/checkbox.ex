...
defmodule DocuSign.Model.Checkbox do
  ...
  @type t :: %__MODULE__{
    ...
    :selectedOriginal => String.t | nil,
    :selectedOriginalMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :shared => String.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.Checkbox do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:selectedOriginalMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
