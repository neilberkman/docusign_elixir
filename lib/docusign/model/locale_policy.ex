...
defimpl Poison.Decoder, for: DocuSign.Model.LocalePolicy do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:currencyNegativeFormatMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
    |> deserialize(:currencyPositiveFormatMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
