...
defmodule DocuSign.Model.PolyLineOverlay do
  ...
  alias DocuSign.Model.GraphicsContext
  alias DocuSign.Model.MergeField
  alias DocuSign.Model.PolyLine
  ...
  @type t :: %__MODULE__{
          ...
          :graphicsContext => GraphicsContext.t() | nil,
          :height => String.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:graphicsContext, :struct, GraphicsContext)
    ...
    |> Deserializer.deserialize(:polyLines, :list, PolyLine)
    |> Deserializer.deserialize(
      :recipientIdGuidMetadata,
      :struct,
      PropertyMetadata
