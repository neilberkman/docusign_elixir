...
defmodule DocuSign.Model.Participant do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :participateFor => String.t | nil,
    :participateForGuid => String.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.Participant do
