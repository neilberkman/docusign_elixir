...
defmodule DocuSign.Model.AccountSignatureProvider do
  ...
  @type t :: %__MODULE__{
    ...
    :signatureProviderOptionsMetadata => [DocuSign.Model.AccountSignatureProviderOption.t] | nil,
    :signatureProviderRequiredOptions => [DocuSign.Model.SignatureProviderRequiredOption.t] | nil
  }
end
