...
defmodule DocuSign.Model.SignHere do
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:optionalMetadata, :struct, DocuSign.Model.PropertyMetadata)
    ...
    |> Deserializer.deserialize(:scaleValueMetadata, :struct, DocuSign.Model.PropertyMetadata)
    |> Deserializer.deserialize(
      :smartContractInformation,
      :struct,
      DocuSign.Model.SmartContractInformation
    )
    |> Deserializer.deserialize(:stamp, :struct, DocuSign.Model.Stamp)
