...
defmodule DocuSign.Model.SignHere do
  ...
  @type t :: %__MODULE__{
          ...
          :optionalMetadata => PropertyMetadata.t() | nil,
          ...
          :scaleValueMetadata => PropertyMetadata.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:optionalMetadata, :struct, PropertyMetadata)
    ...
    |> Deserializer.deserialize(:scaleValueMetadata, :struct, PropertyMetadata)
    |> Deserializer.deserialize(
      :smartContractInformation,
      :struct,
      SmartContractInformation
    )
    |> Deserializer.deserialize(:stamp, :struct, Stamp)
