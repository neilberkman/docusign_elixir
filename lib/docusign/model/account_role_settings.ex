...
defmodule DocuSign.Model.AccountRoleSettings do
  ...
  @type t :: %__MODULE__{
    ...
    :allowedToBeEnvelopeTransferRecipientMetadata => DocuSign.Model.SettingsMetadata.t | nil,
    ...
    :allowPowerFormsAdminToAccessAllPowerFormEnvelopesMetadata => DocuSign.Model.SettingsMetadata.t | nil,
    :allowSendersToSetRecipientEmailLanguage => String.t | nil,
    :allowSendersToSetRecipientEmailLanguageMetadata => DocuSign.Model.SettingsMetadata.t | nil,
    ...
    :enableRecipientViewingNotificationsMetadata => DocuSign.Model.SettingsMetadata.t | nil,
    ...
    :receiveCompletedSelfSignedDocumentsAsEmailLinksMetadata => DocuSign.Model.SettingsMetadata.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.AccountRoleSettings do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:allowedClickwrapsAccessMetadata, :struct, DocuSign.Model.SettingsMetadata, options)
