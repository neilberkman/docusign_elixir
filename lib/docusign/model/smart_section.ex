...
defmodule DocuSign.Model.SmartSection do
  ...
  @type t :: %__MODULE__{
    ...
    :displaySettings => DocuSign.Model.SmartSectionDisplaySettings.t | nil,
    :documentId => String.t | nil,
    :documentIdMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :endAnchor => String.t | nil,
    :endPosition => DocuSign.Model.SmartSectionAnchorPosition.t | nil,
    ...
    :overlayTypeMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    ...
    :startPosition => DocuSign.Model.SmartSectionAnchorPosition.t | nil,
    :status => String.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.SmartSection do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:displaySettings, :struct, DocuSign.Model.SmartSectionDisplaySettings, options)
    |> deserialize(:documentIdMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
    |> deserialize(:endPosition, :struct, DocuSign.Model.SmartSectionAnchorPosition, options)
    ...
    |> deserialize(:startPosition, :struct, DocuSign.Model.SmartSectionAnchorPosition, options)
