...
defmodule DocuSign.Model.PaymentGatewayAccounts do
  ...
  @type t :: %__MODULE__{
    ...
    :supportedPaymentMethodsWithOptions => [DocuSign.Model.PaymentMethodWithOptions.t] | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.PaymentGatewayAccounts do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:supportedPaymentMethodsWithOptions, :list, DocuSign.Model.PaymentMethodWithOptions, options)
  end
end
