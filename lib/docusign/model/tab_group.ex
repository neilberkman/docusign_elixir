...
defmodule DocuSign.Model.TabGroup do
  ...
  @type t :: %__MODULE__{
    ...
    :groupLabel => String.t | nil,
    :groupLabelMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :groupRule => String.t | nil,
    :groupRuleMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :height => String.t | nil,
    :heightMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :maximumAllowed => String.t | nil,
    :maximumAllowedMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    :mergeField => DocuSign.Model.MergeField.t | nil,
    :mergeFieldXml => String.t | nil,
    :minimumRequired => String.t | nil,
    :minimumRequiredMetadata => DocuSign.Model.PropertyMetadata.t | nil,
    ...
    :tabScope => String.t | nil,
    :tabScopeMetadata => DocuSign.Model.PropertyMetadata.t | nil,
...
defimpl Poison.Decoder, for: DocuSign.Model.TabGroup do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:tabScopeMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
