...
defmodule DocuSign.Model.TabGroup do
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:groupLabelMetadata, :struct, DocuSign.Model.PropertyMetadata)
    |> Deserializer.deserialize(:groupRuleMetadata, :struct, DocuSign.Model.PropertyMetadata)
    |> Deserializer.deserialize(:heightMetadata, :struct, DocuSign.Model.PropertyMetadata)
    |> Deserializer.deserialize(:maximumAllowedMetadata, :struct, DocuSign.Model.PropertyMetadata)
    ...
    |> Deserializer.deserialize(:tabScopeMetadata, :struct, DocuSign.Model.PropertyMetadata)
