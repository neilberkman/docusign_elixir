...
defmodule DocuSign.Model.TabGroup do
  ...
  @type t :: %__MODULE__{
          ...
          :groupLabelMetadata => PropertyMetadata.t() | nil,
          :groupRule => String.t() | nil,
          :groupRuleMetadata => PropertyMetadata.t() | nil,
          :height => String.t() | nil,
          :heightMetadata => PropertyMetadata.t() | nil,
          :maximumAllowed => String.t() | nil,
          :maximumAllowedMetadata => PropertyMetadata.t() | nil,
          :mergeField => MergeField.t() | nil,
          :mergeFieldXml => String.t() | nil,
          :minimumRequired => String.t() | nil,
          :minimumRequiredMetadata => PropertyMetadata.t() | nil,
          ...
          :tabScopeMetadata => PropertyMetadata.t() | nil,
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:groupLabelMetadata, :struct, PropertyMetadata)
    |> Deserializer.deserialize(:groupRuleMetadata, :struct, PropertyMetadata)
    |> Deserializer.deserialize(:heightMetadata, :struct, PropertyMetadata)
    |> Deserializer.deserialize(:maximumAllowedMetadata, :struct, PropertyMetadata)
    ...
    |> Deserializer.deserialize(:tabScopeMetadata, :struct, PropertyMetadata)
