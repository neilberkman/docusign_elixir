...
defimpl Poison.Decoder, for: DocuSign.Model.RecipientPhoneAuthentication do
  ...
  def decode(value, options) do
    value
    |> deserialize(:recipMayProvideNumberMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
    ...
    |> deserialize(:validateRecipProvidedNumberMetadata, :struct, DocuSign.Model.PropertyMetadata, options)
  end
end
