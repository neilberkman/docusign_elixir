# NOTE: Originally generated by OpenAPI Generator but has been customized.
# Particularly, the add_param function incorporates DocuSign.ModelCleaner to handle nil values.
...
defmodule DocuSign.RequestBuilder do
  ...
  """
  @spec evaluate_response(Tesla.Env.result() | Tesla.Env.t(), response_mapping) ::
  ...
  def evaluate_response(%Tesla.Env{} = env, mapping) do
    # Handle case when Tesla returns Env directly instead of {:ok, Env}
    resolve_mapping(env, mapping, nil)
  end
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    DocuSign.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    DocuSign.Deserializer.jason_decode(body, module)
  end
end
