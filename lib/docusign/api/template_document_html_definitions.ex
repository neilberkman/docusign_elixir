...
defmodule DocuSign.Api.TemplateDocumentHtmlDefinitions do
  ...
  """
  @spec responsive_html_get_template_document_html_definitions(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.DocumentHtmlDefinitionOriginals.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def responsive_html_get_template_document_html_definitions(connection, account_id, document_id, template_id, _opts \\ []) do
    %{}
    |> method(:get)
