...
defmodule DocuSign.Api.Payments do
  ...
  """
  @spec billing_payments_get_payment(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.BillingPaymentItem.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_payments_get_payment_list(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.BillingPaymentsResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
