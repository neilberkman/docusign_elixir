...
defmodule DocuSign.Api.WorkspaceItems do
  ...
  """
  @spec workspace_file_get_workspace_file(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec workspace_file_pages_get_workspace_file_pages(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.PageImages.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec workspace_file_post_workspace_files(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.WorkspaceItem.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec workspace_file_put_workspace_file(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.WorkspaceItem.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec workspace_folder_delete_workspace_items(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec workspace_folder_get_workspace_folder(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.WorkspaceFolderContents.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
