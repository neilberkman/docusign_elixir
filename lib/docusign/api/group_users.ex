...
defmodule DocuSign.Api.GroupUsers do
  ...
  """
  @spec groups_delete_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.UsersResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec groups_get_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.UsersResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec groups_put_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.UsersResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
