...
defmodule DocuSign.Api.Invoices do
  ...
  """
  @spec billing_invoices_get_billing_invoice(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.BillingInvoice.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_invoices_get_billing_invoices(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.BillingInvoicesResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_invoices_get_billing_invoices_past_due(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.BillingInvoicesSummary.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
