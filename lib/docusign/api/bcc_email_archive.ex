...
defmodule DocuSign.Api.BCCEmailArchive do
  ...
  """
  @spec b_cc_email_archive_delete_bcc_email_archive(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec b_cc_email_archive_get_bcc_email_archive_history_list(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.BccEmailArchiveHistoryList.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec b_cc_email_archive_get_bcc_email_archive_list(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.BccEmailArchiveList.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec b_cc_email_archive_post_bcc_email_archive(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.BccEmailArchive.t} | {:error, Tesla.Env.t}
