...
defmodule DocuSign.Api.DocumentResponsiveHtmlPreview do
  ...
  """
  @spec responsive_html_post_document_responsive_html_preview(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.DocumentHtmlDefinitions.t} | {:error, Tesla.Env.t}
