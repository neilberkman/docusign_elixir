...
defmodule DocuSign.Api.EnvelopeCustomFields do
  ...
  """
  @spec custom_fields_delete_custom_fields(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeCustomFields.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def custom_fields_delete_custom_fields(connection, account_id, envelope_id, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %DocuSign.Model.EnvelopeCustomFields{}},
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec custom_fields_get_custom_fields(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.CustomFieldsEnvelope.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def custom_fields_get_custom_fields(connection, account_id, envelope_id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %DocuSign.Model.CustomFieldsEnvelope{}},
      { 400, %DocuSign.Model.ErrorDetails{}}
    ])
  end
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec custom_fields_post_custom_fields(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeCustomFields.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def custom_fields_post_custom_fields(connection, account_id, envelope_id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 201, %DocuSign.Model.EnvelopeCustomFields{}},
      { 400, %DocuSign.Model.ErrorDetails{}}
    ])
  end
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec custom_fields_put_custom_fields(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeCustomFields.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
