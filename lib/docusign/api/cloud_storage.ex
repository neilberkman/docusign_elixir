...
defmodule DocuSign.Api.CloudStorage do
  ...
  """
  @spec cloud_storage_folder_get_cloud_storage_folder(Tesla.Env.client, String.t, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ExternalFolder.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec cloud_storage_folder_get_cloud_storage_folder_all(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ExternalFolder.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
