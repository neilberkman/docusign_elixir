...
defmodule DocuSign.Api.TemplateDocumentResponsiveHtmlPreview do
  ...
  """
  @spec responsive_html_post_template_document_responsive_html_preview(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.DocumentHtmlDefinitions.t} | {:error, Tesla.Env.t}
  def responsive_html_post_template_document_responsive_html_preview(connection, account_id, document_id, template_id, opts \\ []) do
    ...
    %{}
    |> method(:post)
    |> url("/v2.1/accounts/#{account_id}/templates/#{template_id}/documents/#{document_id}/responsive_html_preview")
