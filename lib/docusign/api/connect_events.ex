...
defmodule DocuSign.Api.ConnectEvents do
  ...
  """
  @spec connect_failures_delete_connect_failure_log(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, Map.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
