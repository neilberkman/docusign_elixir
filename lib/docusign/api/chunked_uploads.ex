...
defmodule DocuSign.Api.ChunkedUploads do
  ...
  """
  @spec chunked_uploads_delete_chunked_upload(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ChunkedUploadResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def chunked_uploads_delete_chunked_upload(connection, account_id, chunked_upload_id, _opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %DocuSign.Model.ChunkedUploadResponse{}},
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec chunked_uploads_get_chunked_upload(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ChunkedUploadResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec chunked_uploads_post_chunked_uploads(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ChunkedUploadResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def chunked_uploads_post_chunked_uploads(connection, account_id, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 201, %DocuSign.Model.ChunkedUploadResponse{}},
      { 400, %DocuSign.Model.ErrorDetails{}}
    ])
  end
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec chunked_uploads_put_chunked_upload_part(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ChunkedUploadResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec chunked_uploads_put_chunked_uploads(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ChunkedUploadResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
