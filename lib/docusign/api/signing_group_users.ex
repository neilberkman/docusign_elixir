...
defmodule DocuSign.Api.SigningGroupUsers do
  ...
  """
  @spec signing_groups_delete_signing_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupUsers.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_get_signing_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupUsers.t} | {:error, Tesla.Env.t}
  def signing_groups_get_signing_group_users(connection, account_id, signing_group_id, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/v2.1/accounts/#{account_id}/signing_groups/#{signing_group_id}/users")
    |> Enum.into([])
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_put_signing_group_users(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupUsers.t} | {:error, Tesla.Env.t}
