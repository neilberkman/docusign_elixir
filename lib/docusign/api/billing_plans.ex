...
defmodule DocuSign.Api.BillingPlans do
  ...
  """
  @spec billing_plan_get_billing_plan(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.AccountBillingPlanResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plan_get_credit_card_info(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.CreditCardInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plan_get_downgrade_request_billing_info(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.DowngradRequestBillingInfoResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plan_put_billing_plan(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.BillingPlanUpdateResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plan_put_downgrade_account_billing_plan(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.DowngradePlanUpdateResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plans_get_billing_plan(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.BillingPlanResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec billing_plans_get_billing_plans(Tesla.Env.client, keyword()) :: {:ok, DocuSign.Model.BillingPlansResponse.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec purchased_envelopes_put_purchased_envelopes(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
