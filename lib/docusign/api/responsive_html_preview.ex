...
defmodule DocuSign.Api.ResponsiveHtmlPreview do
  ...
  """
  @spec responsive_html_post_responsive_html_preview(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.DocumentHtmlDefinitions.t} | {:error, Tesla.Env.t}
