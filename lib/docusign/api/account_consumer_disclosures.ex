...
defmodule DocuSign.Api.AccountConsumerDisclosures do
  ...
  """
  @spec consumer_disclosure_get_consumer_disclosure(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.AccountConsumerDisclosures.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec consumer_disclosure_get_consumer_disclosure_lang_code(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.AccountConsumerDisclosures.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec consumer_disclosure_put_consumer_disclosure(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.ConsumerDisclosure.t} | {:error, Tesla.Env.t}
