...
defmodule DocuSign.Api.AccountPasswordRules do
  ...
  """
  @spec account_password_rules_get_account_password_rules(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.AccountPasswordRules.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec account_password_rules_put_account_password_rules(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.AccountPasswordRules.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec password_rules_get_password_rules(Tesla.Env.client, keyword()) :: {:ok, DocuSign.Model.UserPasswordRules.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
