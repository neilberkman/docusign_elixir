...
defmodule DocuSign.Api.RequestLogs do
  ...
  """
  @spec a_pi_request_log_delete_request_logs(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec a_pi_request_log_get_request_log(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, String.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec a_pi_request_log_get_request_log_settings(Tesla.Env.client, keyword()) :: {:ok, DocuSign.Model.DiagnosticsSettingsInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec a_pi_request_log_get_request_logs(Tesla.Env.client, keyword()) :: {:ok, DocuSign.Model.ApiRequestLogsResult.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec a_pi_request_log_put_request_log_settings(Tesla.Env.client, keyword()) :: {:ok, DocuSign.Model.DiagnosticsSettingsInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
