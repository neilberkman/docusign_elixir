...
defmodule DocuSign.Api.UserCustomSettings do
  ...
  """
  @spec user_custom_settings_delete_custom_settings(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.CustomSettingsInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec user_custom_settings_get_custom_settings(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.CustomSettingsInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec user_custom_settings_put_custom_settings(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.CustomSettingsInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
