...
defmodule DocuSign.Api.SigningGroups do
  ...
  """
  @spec signing_groups_delete_signing_groups(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupInformation.t} | {:error, Tesla.Env.t}
  ...
  - connection (DocuSign.Connection): Connection to server
  - account_id (String.t): The external account number (int) or account ID GUID.
  - signing_group_id (String.t): The ID of the signing group.
  - opts (KeywordList): [optional] Optional parameters
  ## Returns
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_get_signing_group(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.SigningGroup.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_get_signing_groups(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupInformation.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_post_signing_groups(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupInformation.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_put_signing_group(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.SigningGroup.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec signing_groups_put_signing_groups(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, DocuSign.Model.SigningGroupInformation.t} | {:error, Tesla.Env.t}
