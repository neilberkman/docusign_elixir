...
defmodule DocuSign.Api.EnvelopeTransferRules do
  ...
  """
  @spec envelope_transfer_rules_delete_envelope_transfer_rules(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def envelope_transfer_rules_delete_envelope_transfer_rules(connection, account_id, envelope_transfer_rule_id, _opts \\ []) do
    %{}
    |> method(:delete)
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec envelope_transfer_rules_get_envelope_transfer_rules(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeTransferRuleInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec envelope_transfer_rules_post_envelope_transfer_rules(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeTransferRuleInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec envelope_transfer_rules_put_envelope_transfer_rule(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeTransferRule.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec envelope_transfer_rules_put_envelope_transfer_rules(Tesla.Env.client, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeTransferRuleInformation.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
