...
defmodule DocuSign.Api.TemplateDocuments do
  ...
  """
  @spec documents_delete_template_documents(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.TemplateDocumentsResult.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  def documents_delete_template_documents(connection, account_id, template_id, opts \\ []) do
    ...
    |> evaluate_response([
      { 200, %DocuSign.Model.TemplateDocumentsResult{}},
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec documents_get_template_document(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.ErrorDetails.t} | {:ok, String.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec documents_get_template_documents(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.TemplateDocumentsResult.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec documents_put_template_document(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.EnvelopeDocument.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec documents_put_template_documents(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, DocuSign.Model.TemplateDocumentsResult.t} | {:ok, DocuSign.Model.ErrorDetails.t} | {:error, Tesla.Env.t}
